...
namespace clang
{
	namespace metrics
	{
		...
		namespace detail
		{
			...
			private:
				// Helper function. Returns true if and only if decl is an interface.
				...
				//  - It has only static functions, static variables, pure virtual functions and a virtual destructor.
				//  - It contains at least one pure virtual method.
				...
				// Note that the calling of this function requires myInnerClassesByClasses to be already set up.
